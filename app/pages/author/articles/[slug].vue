...
// The shared form store is reused across create/edit. Point it at the author
// flow, then hydrate it from the article matching the [slug] route param so the
// same form components (header / main / sidebar) render in "edit" mode. The
// server ownership guard ensures an author can only load/save their own.
